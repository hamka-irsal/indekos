<footer class="bg-dark position-relative overflow-hidden pb-0 pt-3 pt-lg-8" data-bs-theme="dark">
    ...
    <div class="container position-relative">
                ...
                <div class="row g-4">
                    <div class="col-6 col-md-4">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item"><a class="nav-link pt-0 active" href="about-v1.html">Home</a></li>
                            <li class="nav-item"><a class="nav-link" href="contact-v1.html">Rekomendasi</a></li>
                            <li class="nav-item"><a class="nav-link" href="career.html">Cari Kost</a></li>
                            <li class="nav-item"><a class="nav-link" href="career-single.html">Maps</a></li>
                        </ul>
                    </div>
        ...
        <div class="d-md-flex justify-content-between align-items-center text-center text-lg-start py-4">
            <div class="text-body"> Copyrights ©2024 Indekost, Aplikasi Sistem Pencarian Kost Kecamatan Tamanlanrea </div>
        </div>
    </div>
</footer>