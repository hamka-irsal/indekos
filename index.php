      ...
      <div class="row d-flex justify-content-center">
        <div class="menu-content pb-70 col-lg-8">
          <div class="title text-center">
            ...
            <p>Aplikasi rekomendasi pencarian indekos Kecamatan Tamalanrea ini memuat informasi, rekomendasi dan lokasi dari indekos Kecamatan Tamalanrea. Pemetaan diambil dari data lokasi Google Maps dan data dari website masing-masing tempat indekos. Aplikasi ini memuat sejumlah informasi mengenai :
            </p>
          </div>
        </div>
      </div>
